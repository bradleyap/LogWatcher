...
#process = subprocess.Popen(['java','-jar','Luminator.jar','getPic',fname,'1'],shell=False,stdout=subprocess.PIPE)

	#stdout,stderr = process.communicate()
	#print stdout + ' ' + stderr 
	print process.communicate()[0]
# + process.communicate[1] #returns first element of tuple: (stdout, stderr)
